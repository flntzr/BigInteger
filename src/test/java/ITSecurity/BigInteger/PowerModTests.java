...
public class PowerModTests {
	private static String testFilePath = "src/test/java/ITSecurity/BigInteger/test_files/PowerMod-Tests.txt";
	...
	public PowerModTests(String title, int size, String baseHex, String powerHex, String modHex, String resultHex,
