...
public class EulerPseudoPrimeTests {
	private static String testFilePath = "src/test/java/ITSecurity/BigInteger/test_files/EulerPseudoPrime-Tests.txt";
	...
	public EulerPseudoPrimeTests(String title, int size, String baseHex, String baseDec, String pseudoPrimeHex,
	...
	public void eulerHex() {
		...
		this.testPrimeEuler(base, pseudoPrime, true);
	}
